...
```{r coefplots_socins}
agg_png(filename = "results/Fig2.png", height = 600, width = 1000, res = 144)
plot_coefs(model1_socins,model2_socins, coefs = c("Network Exposure: Culture (t-1)" = "lag_w_expo_culture",
                                    "Network Exposure: Colonial" = "lag_w_expo_colony",
                                    "Network Exposure: Trade (t-1)" = "lag_w_expo_trade",
                                    "Network Exposrue: Spatial Proximity" = "lag_w_expo_proximity", 
                                    "State Founded (last 3 years)" = "existence",
                                    "GDPpc 10k USD" = "gdp10000", 
                                    "Democratization" = "regime"), colors = "Qual3", title = "Logit Coefficients for Work-Injury Social Insurance Laws Models")
dev.off()
