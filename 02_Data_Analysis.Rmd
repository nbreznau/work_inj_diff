...
Including Agriculture instead of GDP. This still needs work as the period 1990 to 2010 seems to have mostly been interpolated and therefore, not of much use. *Try linear interpolation rather than simply filling in the most recent values* because some countries have no observations until later and this relly messes up the data.
...
ggsurvplot(fit1, data = diff_data_gdp, 
           ...
           ylab = "")
dev.off()
knitr::include_graphics("results/Fig3_A.png")
```
...
ggsurvplot(fit3, data = diff_data_socins_gdp, 
           ...
           ylab = "")
dev.off()
knitr::include_graphics("results/Fig3_B.png")
