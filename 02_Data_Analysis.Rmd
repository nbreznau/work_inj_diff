...
Then we re-run our main models with this variable included.
...
#summary(model2)
#exp(coef(model2))
stargazer(model3_sens2,model3_socins_sens2,
          type = "text", 
          title = "Discrete Time Hazard/Diffusion Models of /nWork-Injury Law, 1880-2010 in 152 countries",
...
```{r se_corrections1}
stargazer3(list(m1, m2, m3, m3x), odds.ratios = T, origin_model = list(model1, model2, model3, model3_sens2), type = "text", se = list(NA, NA, NA, NA),
...
```{r se_corrections2}
stargazer3(list(m4, m5, m6, m6x), odds.ratios = T, origin_model = list(model1_socins, model2_socins, model3_socins, model3_socins_sens2), type = "text", se = list(NA, NA, NA, NA),
           title = "Diffusion of Work-Injury Laws, 151 Countries, 1880-2010",
          covariate.labels=c("(1880-1902)", 
                             "(1903-1928)",
                             "(1929-1954)",
